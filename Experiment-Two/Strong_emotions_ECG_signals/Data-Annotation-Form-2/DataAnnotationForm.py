...
wb = load_workbook('Experiment-Two/Experiment 2/Data-Annotation-Form-2/Excel Database 2.xlsx')
sheet = wb.active
...
file_path_dict = {"Fear":"Experiment-Two/Experiment 2/Data-Annotation-Form-2/Audio_stimuli - Strong_emotions/Fear",  
				  "Sadness":"Experiment-Two/Experiment 2/Data-Annotation-Form-2/Audio_stimuli - Strong_emotions/Sadness", 
				  "Happiness":"Experiment-Two/Experiment 2/Data-Annotation-Form-2/Audio_stimuli - Strong_emotions/Happinesss"}
...
def insert():
	...
	# save the file
	wb.save('Experiment-Two/Experiment 2/Data-Annotation-Form-2/Excel Database 2.xlsx')
...
def play():
	...
	# #playing with simpleaudio module
...
if __name__ == "__main__":
	...
	sound_group.set("Which emotion group? ") # default value
	w3 = OptionMenu(root, sound_group, "Fear", "Happiness", "Sadness", command = get_sound_group)
